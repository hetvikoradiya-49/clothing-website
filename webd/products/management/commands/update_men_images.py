"""
Management command to update existing men products with images from image/men folder.
"""
import os
import shutil
...
class Command(BaseCommand):
    help = 'Update existing men products with images from image/men folder'

    def handle(self, *args, **options):
        # Source and destination paths
        source_folder = os.path.join(settings.BASE_DIR, 'image', 'men')
        ...
        products_to_update = [
            {
                'product_slug': 'classic-white-shirt',
            ...
            {
                'product_slug': 'wool-blazer',
                'filename': 'wool blazer.jpg',
            },
        ]
        ...
        self.stdout.write(self.style.SUCCESS('\nMen products updated with images successfully!'))
